      ...
      <nav class="navbar col-lg-12 col-12 px-0 py-0 py-lg-4 d-flex flex-row">
        <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
          ...
          <div class="navbar-brand-wrapper">
            <a class="navbar-brand brand-logo" href="index.html"><img src="../assets/templates/spica/template/images/logo.svg" alt="logo"/></a>
            <a class="navbar-brand brand-logo-mini" href="index.html"><img src="../assets/templates/spica/template/images/logo-mini.svg" alt="logo"/></a>
          </div>
          <h4 class="font-weight-bold mb-0 d-none d-md-block mt-1">Welcome back, <?php echo $_SESSION['nama_user'] ?? 'User'; ?></h4>
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                      <img src="../assets/templates/spica/template/images/faces/face4.jpg" alt="image" class="profile-pic">
                  </div>
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                      <img src="../assets/templates/spica/template/images/faces/face2.jpg" alt="image" class="profile-pic">
                  </div>
                  <div class="preview-item-content flex-grow">
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                      <img src="../assets/templates/spica/template/images/faces/face3.jpg" alt="image" class="profile-pic">
                  </div>
                  <div class="preview-item-content flex-grow">
          ...
          <ul class="navbar-nav navbar-nav-right">
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" id="profileDropdown">
                <img src="../assets/templates/spica/template/images/faces/face5.jpg" alt="profile"/>
                <span class="nav-profile-name"> <?php echo $_SESSION['nama_user'] ?? 'User'; ?></span>
              </a>
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped">
                      ...
                      <tbody>
                        <tr>
                          <td class="py-1">
                            <img src="../assets/templates/spica/template/images/faces/face1.jpg" alt="image"/>
                          </td>
                          <td>
                            Herman Beck
                          </td>
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="../assets/templates/spica/template/images/faces/face2.jpg" alt="image"/>
                          </td>
                          <td>
                            Messsy Adam
                          </td>
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="../assets/templates/spica/template/images/faces/face3.jpg" alt="image"/>
                          </td>
                          <td>
                            John Richards
                          </td>
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="../assets/templates/spica/template/images/faces/face4.jpg" alt="image"/>
                          </td>
                          <td>
                            Peter Meggik
                          </td>
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="../assets/templates/spica/template/images/faces/face5.jpg" alt="image"/>
                          </td>
                          <td>
                            Edward
                          </td>
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="../assets/templates/spica/template/images/faces/face6.jpg" alt="image"/>
                          </td>
                          <td>
                            John Doe
                          </td>
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="../assets/templates/spica/template/images/faces/face7.jpg" alt="image"/>
                          </td>
                          <td>
                            Henry Tom
                          </td>
